...
<a href="about.html" class="theme-btn">About More<i class="fas fa-arrow-right-long"></i></a>
<a href="contact.html" class="theme-btn theme-btn2">Learn More<i class="fas fa-arrow-right-long"></i></a>
</div>
</div>
</div>
</div>
...
<a href="<?php echo e(route('shop')); ?>">Electronic Wire</a>
</h3>
...
<a href="<?php echo e(route('shop')); ?>">Read More<i class="fas fa-arrow-right-long"></i></a>
</div>
</div>
</div>
</div>
...
<div class="service-content">
<h3 class="service-title">
<a href="<?php echo e(route('etc')); ?>">Switches</a>
</h3>
<p class="service-text">
...
<div class="service-arrow">
<a href="<?php echo e(route('etc')); ?>">Read More<i class="fas fa-arrow-right-long"></i></a>
</div>
</div>
</div>
</div>
...
<div class="service-content">
<h3 class="service-title">
<a href="<?php echo e(route('shop2')); ?>">Resistor</a>
</h3>
<p class="service-text">
...
<div class="service-arrow">
<a href="<?php echo e(route('shop2')); ?>">Read More<i class="fas fa-arrow-right-long"></i></a>
</div>
</div>
</div>
</div>
...
<div class="service-content">
<h3 class="service-title">
<a href="<?php echo e(route('shop3')); ?>">Capacitor</a>
</h3>
<p class="service-text">
...
<div class="service-arrow">
<a href="<?php echo e(route('shop3')); ?>">Read More<i class="fas fa-arrow-right-long"></i></a>
</div>
</div>
</div>
</div>
...
<div class="service-content">
<h3 class="service-title">
<a href="<?php echo e(route('shop4')); ?>">LED Chip</a>
</h3>
<p class="service-text">
LED chip contain small semiconductor chips that emit light when an electric current is passed through them.
</p>
<div class="service-arrow">
<a href="<?php echo e(route('shop4')); ?>">Read More<i class="fas fa-arrow-right-long"></i></a>
</div>
</div>
</div>
</div>
...
<div class="service-content">
<h3 class="service-title">
<a href="<?php echo e(route('shop5')); ?>">Inductors</a>
</h3>
<p class="service-text">
An inductor, also called a coil, choke, or reactor, is a passive two-terminal electrical component that stores energy.
</p>
<div class="service-arrow">
<a href="<?php echo e(route('shop5')); ?>">Read More<i class="fas fa-arrow-right-long"></i></a>
</div>
</div>
</div>
</div>
...
<div class="service-content">
<h3 class="service-title">
<a href="<?php echo e(route('shop6')); ?>">Diodes</a>
</h3>
<p class="service-text">
Diodes can be used as rectifiers, signal limiters, voltage regulators, switches, signal modulators, signal mixers etc.
</p>
<div class="service-arrow">
<a href="<?php echo e(route('shop6')); ?>">Read More<i class="fas fa-arrow-right-long"></i></a>
</div>
</div>
</div>
</div>
...
<div class="service-content">
<h3 class="service-title">
<a href="<?php echo e(route('shop7')); ?>">Transistor</a>
</h3>
<p class="service-text">
...
<div class="service-arrow">
<a href="<?php echo e(route('shop7')); ?>">Read More<i class="fas fa-arrow-right-long"></i></a>
</div>
</div>
</div>
</div>
...
<a href="portfolio-single.html" class="portfolio-btn"><i class="far fa-arrow-right"></i></a>
</div>
</div>
</div>
</div>
...
<div class="col-lg-6 mx-auto">
<div class="site-heading text-center">
<span class="site-title-tagline"><i class="far fa-lightbulb-on"></i> Our Pricing</span>
<h2 class="site-title">Choose Perfect <span>Plan</span></h2>
</div>
</div>
</div>
<div class="row">
...
<h4>Basic</h4>
<h1 class="pricing-amount">$599<span class="pricing-duration">/Month</span></h1>
</div>
</div>
...
<a href="pricing.html" class="theme-btn">Choose Plan<i class="fas fa-arrow-right-long"></i></a>
</div>
</div>
</div>
<div class="col-md-6 col-lg-4">
...
<div class="pricing-header-content">
<h4>Standard</h4>
<h1 class="pricing-amount">$799<span class="pricing-duration">/Month</span></h1>
</div>
</div>
<div class="pricing-feature">
<ul>
...
<div class="pricing-header-content">
<h4>Enterprise</h4>
<h1 class="pricing-amount">$899<span class="pricing-duration">/Month</span></h1>
</div>
</div>
<div class="pricing-feature">
<ul>
...
<h1>Get Awesome Experience With Our Electrow Services</h1>
...
<div class="site-heading mb-3">
<span class="site-title-tagline justify-content-start"><i class="far fa-lightbulb-on"></i> Faq's</span>
...
<div class="blog-date"><i class="fal fa-calendar-alt"></i> May 24, 2023</div>
</div>
...
<p>There are many variations of passages but the majority have suffered alteration in some form are going passage by injected humour.</p>
...
<?php /**PATH C:\Users\IDEAL COMPUTER'S\Documents\GitHub\lab-automation\eproject-Ali\resources\views/main-web/components/main.blade.php ENDPATH**/ ?>