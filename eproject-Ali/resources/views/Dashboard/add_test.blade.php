...
<div class="col-sm-12 col-xl-11" style="margin-left: 20px; margin-top: 20px">
                        <div class="bg-light rounded h-100 p-4">
                            <h3 class="mb-4">ADD TEST</h3>
                            <form method="POST" enctype="multipart/form-data">
                                <input type="hidden" disabled value="<?php echo $id ?>">
                                <div class="row mb-3">
                                ...
                                <button type="submit" name="btn" class="btn btn-primary">SUBMIT</a>
                            </form>
                        </div>
                    </div>
                    ...
                    <?php
                        ...
                        $query = "Insert into test values('','$name','$desc')";
